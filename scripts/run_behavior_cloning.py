...
from assignment_Imitation_Learning.infrastructure.rl_trainer import RL_Trainer
from assignment_Imitation_Learning.agents.bc_agent import BCAgent
from assignment_Imitation_Learning.policies.loaded_gaussian_policy import Loaded_Gaussian_Policy
...
def main():
    ...
    parser.add_argument('--env_name', '-env', type=str, help='choices: Ant-v2, Humanoid-v2, Walker-v2, HalfCheetah-v2, Hopper-v2',
                        required=True)
    ...
    parser.add_argument('--num_agent_train_steps_per_iter', type=int,
                        default=10000)  # number of gradient steps for training policy (per iter in n_iter)
