...
from assignment_Imitation_Learning.infrastructure.logger import Logger
...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        ...
        # depending on if it's the first iteration or not,
        ...
        paths, envsteps_this_batch = utils.sample_trajectories(self.env, collect_policy, self.params['ep_len'], render=False, render_mode=('rgb_array'))
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths):
        ...
        eval_paths, eval_envsteps_this_batch = sample_trajectories(self.env, eval_policy, self.params['eval_batch_size'],
                                                                   self.params['ep_len'])
